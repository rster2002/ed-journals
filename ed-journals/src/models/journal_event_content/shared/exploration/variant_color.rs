...
use crate::models::journal_event_content::shared::exploration::variant::{Variant, VariantError};
...
impl TryFrom<(&Species, &VariantSource)> for VariantColor {
    ...
    fn try_from(value: (&Species, &VariantSource)) -> Result<Self, Self::Error> {
        ...
        Ok(match (genus, value.0, value.1) {
            ...
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::O)) => VariantColor::Turquoise,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::B)) => VariantColor::Grey,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::A)) => VariantColor::Yellow,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::F)) => VariantColor::Lime,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::G)) => VariantColor::Emerald,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::K)) => VariantColor::Green,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::M)) => VariantColor::Teal,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::L)) => VariantColor::Sage,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::T)) => VariantColor::Red,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::TTS)) => VariantColor::Maroon,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::W)) => VariantColor::Amethyst,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::D)) => VariantColor::Ocher,
            (_, Species::BacteriumAlcyoneum | Species::BacteriumAurasus | Species::BacteriumCerbrus, VariantSource::StarClass(StarClass::N)) => VariantColor::Indigo,
            ...
            (_, Species::ConchaAureolas | Species::ConchaLabiata, VariantSource::StarClass(StarClass::A)) => VariantColor::Teal,
            (_, Species::ConchaAureolas | Species::ConchaLabiata, VariantSource::StarClass(StarClass::F)) => VariantColor::Grey,
            (_, Species::ConchaAureolas | Species::ConchaLabiata, VariantSource::StarClass(StarClass::G)) => VariantColor::Turquoise,
            (_, Species::ConchaAureolas | Species::ConchaLabiata, VariantSource::StarClass(StarClass::K)) => VariantColor::Red,
            (_, Species::ConchaAureolas | Species::ConchaLabiata, VariantSource::StarClass(StarClass::L)) => VariantColor::Orange,
            (_, Species::ConchaAureolas | Species::ConchaLabiata, VariantSource::StarClass(StarClass::N)) => VariantColor::Emerald,
            ...
            (Genus::Fonticulua, _, VariantSource::StarClass(StarClass::AeBe)) => VariantColor::Maroon,
            ...
            (_, Species::FumerolaCarbosis, VariantSource::Material(Material::Tin)) => VariantColor::Teal,
            ...
            (_, Species::OsseusCornibus | Species::OsseusFractus | Species::OsseusPellebantus | Species::OsseusSpiralis, VariantSource::StarClass(StarClass::A)) => VariantColor::Lime,
            (_, Species::OsseusCornibus | Species::OsseusFractus | Species::OsseusPellebantus | Species::OsseusSpiralis, VariantSource::StarClass(StarClass::F)) => VariantColor::Turquoise,
            (_, Species::OsseusCornibus | Species::OsseusFractus | Species::OsseusPellebantus | Species::OsseusSpiralis, VariantSource::StarClass(StarClass::G)) => VariantColor::Grey,
            (_, Species::OsseusCornibus | Species::OsseusFractus | Species::OsseusPellebantus | Species::OsseusSpiralis, VariantSource::StarClass(StarClass::K)) => VariantColor::Indigo,
            (_, Species::OsseusCornibus | Species::OsseusFractus | Species::OsseusPellebantus | Species::OsseusSpiralis, VariantSource::StarClass(StarClass::T)) => VariantColor::Emerald,
            (_, Species::OsseusCornibus | Species::OsseusFractus | Species::OsseusPellebantus | Species::OsseusSpiralis, VariantSource::StarClass(StarClass::TTS)) => VariantColor::Green,
