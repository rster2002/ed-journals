...
#[cfg(test)]
mod tests {
    use crate::journal_event_content::carrier_trade_order_event::{CarrierTradeOrderEvent, CarrierTradeOrderEventOrder};
    use crate::journal_event_content::shared::trading::commodity::Commodity;

    #[test]
    fn carrier_trade_purchase_order_is_parsed_correctly() {
        let result = serde_json::from_str::<CarrierTradeOrderEvent>(r#"
            {
        ...
        assert!(result.is_ok());
        assert_eq!(result.unwrap(), CarrierTradeOrderEvent {
