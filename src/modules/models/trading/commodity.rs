...
impl Commodity {
    fn name_to_commodity(name: &str) -> Result<Commodity, CommodityError> {
        ...
        match lower_case {
            ...
            "thargoidtitandeeptissuesample" => Ok(Commodity::TitanDeepTissueSample),
            "thargoidtitandrivecomponent" => Ok(Commodity::TitanDriveComponent),
            "thargoidtitanmawdeeptissuesample" => Ok(Commodity::TitanMawDeepTissueSample),
            "thargoidtitanmawpartialtissuesample" => Ok(Commodity::TitanMawPartialTissueSample),
            "thargoidtitanmawtissuesample" => Ok(Commodity::TitanMawTissueSample),
            "thargoidtitanpartialtissuesample" => Ok(Commodity::TitanPartialTissueSample),
            "thargoidtitantissuesample" => Ok(Commodity::TitanTissueSample),
