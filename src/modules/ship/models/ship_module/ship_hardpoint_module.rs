...
impl ShipHardpointModule {
    ...
    fn get_module_class(module: &HardpointModule, mounting: &HardpointMounting, size: &HardpointSize) -> ModuleClass {
        match (&module, &mounting, &size) {
            ...
            (HardpointModule::BurstLaser, HardpointMounting::Gimballed | HardpointMounting::Turreted, HardpointSize::Small) => ModuleClass::G,
