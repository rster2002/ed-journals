...
impl FromStr for ShipType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Ok(match string {
            ...
            "explorer_nx" => ShipType::CaspianExplorer,
            ...
            "mediumtransport01" => ShipType::LynxHighliner,
            "lakonminer" => ShipType::Type11Prospector,
            "mamba" => ShipType::Mamba,
            "mandalay" => ShipType::Mandalay,
            "orca" => ShipType::Orca,
            "panthermkii" => ShipType::PantherClipperMkII,
            "python" => ShipType::Python,
            "python_nx" => ShipType::PythonMkII,
            "sidewinder" => ShipType::SideWinder,
            "smallcombat01_nx" => ShipType::KestrelMkII,
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(
            ...
            match self {
                ...
                ShipType::KestrelMkII => "Kestrel Mk II",
                ShipType::KraitMkII => "Krait Mk II",
                ShipType::KraitPhantom => "Krait Phantom",
                ShipType::LynxHighliner => "Lynx Highliner",
                ShipType::Mamba => "Mamba",
                ShipType::Mandalay => "Mandalay",
                ShipType::Orca => "Orca",
                ShipType::PantherClipperMkII => "Panther Clipper MkII",
                ShipType::Python => "Python",
                ShipType::PythonMkII => "Python Mk II",
                ShipType::SideWinder => "Sidewinder",
                ShipType::Type6Transporter => "Type-6 Transporter",
                ShipType::Type7Transporter => "Type-7 Transporter",
                ShipType::Type8Transporter => "Type-8 Transporter",
                ShipType::Type9Heavy => "Type-9 Heavy",
                ShipType::Type10Defender => "Type-10 Defender",
                ShipType::Type11Prospector => "Type-11 Prospector",
