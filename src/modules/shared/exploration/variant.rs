...
use crate::modules::shared::exploration::variant_color::{
    VariantColor, VariantColorError,
};
use crate::modules::shared::exploration::variant_source::{
...
mod tests {
    ...
    use crate::modules::shared::exploration::variant_color::VariantColor;
