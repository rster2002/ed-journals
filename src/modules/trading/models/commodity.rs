...
impl Commodity {
    fn name_to_commodity(name: &str) -> Result<Commodity, CommodityError> {
        ...
        Ok(match lower_case {
            ...
            "powerpreparationspyware" => Commodity::PowerplayInjectionMalware,
            "powerspyware" => Commodity::PowerplayTrackerMalware,
            ...
            "alliancetradeagreements" => Commodity::AllianceTradeAgreements,
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        write!(
            ...
            match self {
                ...
                Commodity::PowerplayTrackerMalware => "Power Tracker Malware",
                Commodity::PowerplayInjectionMalware => "Power Injection Malware",
                ...
                Commodity::AllianceTradeAgreements => "Alliance Trade Agreements",
